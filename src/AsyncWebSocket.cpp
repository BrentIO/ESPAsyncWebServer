...
AsyncWebSocketClient::AsyncWebSocketClient(AsyncWebServerRequest *request, AsyncWebSocket *server)
  : _controlQueue(AsyncWebServerLinkedList<AsyncWebSocketControl *>([](AsyncWebSocketControl *c){ delete  c; }))
  , _messageQueue(AsyncWebServerLinkedList<AsyncWebSocketMessage *>([](AsyncWebSocketMessage *m){ delete  m; }))
  , _tempObject(NULL)
{
...
AsyncWebSocket::AsyncWebSocket(const String& url)
  :_url(url)
  ,_clients(AsyncWebServerLinkedList<AsyncWebSocketClient *>([](AsyncWebSocketClient *c){ delete c; }))
  ,_cNextId(1)
  ,_enabled(true)
  ,_buffers(AsyncWebServerLinkedList<AsyncWebSocketMessageBuffer *>([](AsyncWebSocketMessageBuffer *b){ delete b; }))
{
  _eventHandler = NULL;
}
...
AsyncWebSocket::AsyncWebSocketClientAsyncWebServerLinkedList AsyncWebSocket::getClients() const {
  return _clients;
}
